...
CREATE TABLE timeline_events (
    ...
    user_name VARCHAR(255) NOT NULL, -- Denormalized for history
    data TEXT NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE files (
    ...
    file_path VARCHAR(500), -- For future actual file storage
    uploaded_by INTEGER REFERENCES users(id) ON DELETE SET NULL,
    uploaded_by_name VARCHAR(255) NOT NULL, -- Denormalized
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
